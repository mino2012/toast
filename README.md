# crmistic [![Build Status](https://travis-ci.org/florentL/toast-next-gen.svg?branch=master)](https://travis-ci.org/florentL/toast-next-gen)
...
To optimize the crmistic application for production, run:
