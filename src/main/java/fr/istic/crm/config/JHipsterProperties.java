...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "crmistic@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "crmistic API";

        private String description = "crmistic API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "crmistic";
